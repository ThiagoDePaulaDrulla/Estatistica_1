...
# Em estudos de preÁos de imoveis eh comum utilizarmos uma funcao log-linear
...
# Vamos verificar a existencia de multicolineariedade, que È verificar alta
